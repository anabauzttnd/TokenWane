 ...
 * This file demonstrates how to integrate Tokenwane with a web frontend
 */

// For React/Vue/Angular applications
export class TokenwaneClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TokenwaneClient(provider, contractAddress);
